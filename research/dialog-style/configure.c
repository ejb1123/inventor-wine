...
void mainCRTStartup(void) {
 const WCHAR *style=L"C:\\windows\\resources\\themes\\research\\compact.msstyles";
 ...
 MessageBoxW(0,L"The dialog font is now larger and smoother. Check that this text and the buttons are comfortably readable.\n\nThis is only a display preview; it does not modify your models.",L"Inventor dialog appearance preview",MB_YESNOCANCEL|MB_ICONINFORMATION);
 ExitProcess(0);
}
