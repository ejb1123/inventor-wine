...
void mainCRTStartup(void) {
 ...
 WCHAR *name=L"GraphicsDriverType"; DISPID id,put=DISPID_PROPERTYPUT; VARIANT v; VariantInit(&v); v.vt=VT_I4; v.lVal=61448; check(IDispatch_GetIDsOfNames(hw.pdispVal,&IID_NULL,&name,1,LOCALE_USER_DEFAULT,&id),"driver property"); DISPPARAMS dp={&v,&put,1,1}; check(IDispatch_Invoke(hw.pdispVal,id,&IID_NULL,LOCALE_USER_DEFAULT,DISPATCH_PROPERTYPUT,&dp,0,0,0),"set DX11");
